...
using FinalProject.Teams.TeamA.Pathfinding.Scripts.Observer;
using General_Scripts;
using SteeringBehaviours.Scripts.Basics;
using UnityEngine;

namespace FinalProject.Teams.TeamA.Pathfinding.Scripts.Pathfinding
{
    /// <summary>
    ...
    public class Unit : MonoBehaviour, IListener, IUnit
    {
        ...
        private void Start()
        {
            ...
            _pathRequestManager.RegisterListener(this);
        }
        ...
        public void RequestPath(Transform target, bool forceRequest = false)
        {
            ...
            if (target != null && ((target.position - _previousTargetPosition).sqrMagnitude > _sqrMoveThreashold || forceRequest || _path != null && _path.FinishLineIndex == -1))
            {
                ...
                _pathRequestManager.RequestPath(_myPathRequest);
        ...
        public void IsCarring()
        {
            MovementSpeed = 1f;
            _steering.MaxVelocity = 3f;

        }

        public void RecoverNormalSpeed()
        {
            MovementSpeed = 2f;
            _steering.MaxVelocity = 5f;
        }
