...
namespace FinalProject.Teams.TeamA.Pathfinding.Scripts.Pathfinding
{
    public class Grid : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _pathRequestManager = GameObject.FindGameObjectWithTag("TeamA").GetComponent<PathRequestManager>();
        ...
        {
            yield return null; // wait one frame before create the grid to give the engine time to spawn the plants
